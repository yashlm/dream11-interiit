  ...
  const steps = [
    ...
    },
    {
      ...
      options: [
        ...
        {
          value: 3,
          label: "How do I change my profile picture?",
          trigger: "7",
        },
    ...
    },
    {
      id: "5",
      message:
        "Yes, use the chat feature to contact the seller directly after clicking on the buy now button.",
      trigger: "9",
    },
    {
      id: "6",
      message:
        "Click the edit icon next to your profile information to update your details.",
      trigger: "9",
    },
    {
      id: "7",
    ...
    },
    {
      id: "8",
      message:
        "Click the 'Buy Now' button on that product's page to start the purchase process.",
      trigger: "9",
    },
    {
      id: "9",
